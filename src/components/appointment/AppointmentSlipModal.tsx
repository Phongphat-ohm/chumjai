...
export function AppointmentSlipModal({
  ...
  // Generate PDF Blob when modal opens or appointment changes
  useEffect(() => {
  ...
  const handleDownload = () => {
    ...
    link.download = `appointment_${appointment.patient.hn}_${appointment.id}.pdf`;
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-950">
                  ตัวอย่างใบนัดหมายผู้ป่วย (PDF Preview)
                </h3>
            ...
            <div className="flex flex-col items-center justify-center p-12 text-center space-y-3 bg-white rounded-2xl shadow-sm border border-slate-200 max-w-md mx-auto">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900">
                  กำลังสร้างไฟล์ PDF ตัวอย่างใบนัดหมาย...
                </h4>
