    ...
    <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-chunjai-950">
              รายงานสรุปผลและการวิเคราะห์การบริหารคลินิก (Executive Analytics)
            </h1>
          </div>
          <p className="text-xs text-slate-500 mt-1">
            สรุปสถิติผู้ป่วย สรุป 10 อันดับโรคที่พบมากที่สุด สัดส่วนสิทธิการรักษา และมูลค่ายาในคลัง
          </p>
        </div>
      ...
      {isPending && !reportData ? (
        <div className="p-20 text-center text-slate-400 space-y-2">
          ...
          <p className="text-xs font-medium">กำลังประมวลผลรายงานสรุปผล...</p>
        </div>
      ) : reportData ? (
        <div className="space-y-6">
          ...
          {/* Section: Top 10 ICD-10 Diagnoses Breakdown */}
